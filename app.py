...
def predict():
    ...
    '''
    consumerKey="etuXjVWafJDNSbXPWm9pfzCjG"
    consumerSecret="1v2wRtJ7s1GiH5SIfUAlFehFt2wqVFh8sWZL8noVTcJ0Igj5T8"
    accessToken="780951174086168576-MsQIMhqgy1PpJxqH3bcq0BT8lPIDHmc"
    accessTokenSecret="2skub6nwlCknKDv1YEqvOpUnI2JHfXlHY3k5OQipgGLZX"
    ...
    '''
    return render_template('index.html', prediction_text='Overall Result : {}'.format([print(key, value) for key, value in res.items()]))
